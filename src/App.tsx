        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <input
              ...
              className="pl-10 pr-4 py-2 w-64 bg-gray-800 text-white border-gray-700 placeholder:text-gray-400 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
